...
Public Class Reporte_Abonos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SunChangSystem.Reporte_Abonos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Abonos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Abonos = New Reporte_Abonos()
        rpt.Site = Me.Site
        Return rpt
    End Function
