...
Public Class Reporte_Imp_Ventas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SunChangSystem.Reporte_Imp_Ventas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Imp_Ventas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Imp_Ventas = New Reporte_Imp_Ventas()
        rpt.Site = Me.Site
        Return rpt
    End Function
