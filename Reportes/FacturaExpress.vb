...
Public Class FacturaExpress
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SunChangSystem.FacturaExpress.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFacturaExpress
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacturaExpress = New FacturaExpress()
        rpt.Site = Me.Site
        Return rpt
    End Function
