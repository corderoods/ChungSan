...
Public Class Reporte_Vales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SunChangSystem.Reporte_Vales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Vales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Vales = New Reporte_Vales()
        rpt.Site = Me.Site
        Return rpt
    End Function
