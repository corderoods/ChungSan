...
Public Class Reporte_de_Fondos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SunChangSystem.Reporte_de_Fondos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_de_Fondos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_de_Fondos = New Reporte_de_Fondos()
        rpt.Site = Me.Site
        Return rpt
    End Function
