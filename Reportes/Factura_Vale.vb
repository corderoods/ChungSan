...
Public Class Factura_Vale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SunChangSystem.Factura_Vale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFactura_Vale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Factura_Vale = New Factura_Vale()
        rpt.Site = Me.Site
        Return rpt
    End Function
