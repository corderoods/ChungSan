...
Public Class Factura_Abono
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SunChangSystem.Factura_Abono.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFactura_Abono
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Factura_Abono = New Factura_Abono()
        rpt.Site = Me.Site
        Return rpt
    End Function
